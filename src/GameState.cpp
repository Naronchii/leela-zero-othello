...
// This class is an extension of the class KoState

// Initializes the game by initializing a kostate and other variables like time clock and previous states.
void GameState::init_game(const int size, const float komi) {
    KoState::init_game(size, komi);

    m_game_history.clear(); // Vector of kostates.
